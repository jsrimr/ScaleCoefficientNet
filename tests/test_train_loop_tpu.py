...
from tpu_train_loop import RunManager, DistributedRunConfig
...
def test_tpu_train_loop():
    # once-for-all/ofa/imagenet_classification/elastic_nn/training/progressive_shrinking.py
